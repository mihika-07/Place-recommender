...
2. Run the project using a local development server  
...
Mihika Goyal  
Second-year Computer Science undergraduate with interests in full-stack development, machine learning, and building real-world applications.
